...
def experimentation_5G(file_path):
    ...
    ax1.set_title('Nombre de projets par technologie 5G', fontsize=14)
    ax1.set_ylabel('Nombre de projets', fontsize=12)
    ax1.set_xticklabels(techno_totals.index, rotation=45, ha='right', fontsize=10)
    ax1.set_xlabel("Technologies", fontsize=12)
    ...
    ax2.set_title('Nombre de projets par usage 5G', fontsize=14)
    ax2.set_ylabel('Nombre de projets', fontsize=12)
    ax2.set_xticklabels(usage_totals.index, rotation=45, ha='right', fontsize=10)
    ax2.set_xlabel("Usages", fontsize=12)
